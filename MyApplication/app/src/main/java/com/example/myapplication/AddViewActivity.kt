...
class AddViewActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(layout.activity_add_view)
        ...
        val container = findViewById<LinearLayout>(id.addview_container)
        val inflater = LayoutInflater.from(this@AddViewActivity)
        for (i in 0 until carList.size) {
            val itemView = inflater.inflate(layout.item_view, null)
