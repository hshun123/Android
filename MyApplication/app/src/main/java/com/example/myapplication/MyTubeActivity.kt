            ...
            .enqueue(object : Callback<ArrayList<Youtube>> {
                override fun onResponse(
                    ...
                    if(response.isSuccessful){
                        ...
                        val adapter = MytubeAdapter(youtubeList!!,
...
class MytubeAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val title: TextView
        val thumbmail: ImageView
        val content: TextView


        init {
            title = itemView.findViewById(R.id.youtube_title)
            thumbmail = itemView.findViewById(R.id.youtube_thumbnail)
            ...
            itemView.setOnClickListener{
                ...
                intent.putExtra("video_url", youtubeList.get(position).vidieo)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        glide.load(youtubeList.get(position).thumbmail).into(holder.thumbmail)
    }
